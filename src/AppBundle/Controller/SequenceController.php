...
class SequenceController extends Controller
{
     ...
     * Finds and displays a sequence entity.
     *
     * @Route("/repondre/{id}", name="sequence_repondre")
     * @Method("GET")
     */
    public function afficherQuestionAction(Sequence $sequence)
    {
        $em = $this->getDoctrine()->getManager();
        
        $user = $em->getRepository("AppBundle:Utilisateur")->find(1);
        
        $question = $sequence->getQuestionsSequence();
